...
bind = "0.0.0.0:8443"
backlog = 2048
certfile = os.environ.get("GUNICORN_SSL_CRT", "/home/tunnel/certs/tunnel.crt")
keyfile = os.environ.get("GUNICORN_SSL_KEY", "/home/tunnel/certs/tunnel.key")
preload_app = True
...
def on_starting(server):
    server.log.access_log.addFilter(RequestPathFilter(path_re=r"^/api/health/$"))
